    ...
    <div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Tambah Portofolio
                    </h2>
        ...
        <div class="row">
            <div class="col-12">
                <div class="content-body">
                    <div class="card">
                        <div class="card-body">
                            <form id="jquery-val-form" class="forms-sample" action="{{route('admin.portofolio.store')}}" method="post" enctype="multipart/form-data" >
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-sm-12">
                                          <input type="text" id="klien" name="klien" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control flatpickr-basic" id="tanggal" name="tanggal" placeholder="Pilih"
