    ...
    <div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Ubah Portofolio
                    </h2>
        ...
        <div class="row">
            <div class="col-12">
                <div class="content-body">
                    <div class="card">
                        <div class="card-body">
                            <form id="jquery-val-form" class="forms-sample" action="{{route('admin.portofolio.update')}}" method="post" enctype="multipart/form-data" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8 col-12">
                                        ...
                                        <div class="col-sm-12">
                                          <input type="text" id="nama" name="nama" required value="{{$data->nama}}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-sm-12">
                                          <input type="text" id="klien" name="klien" value="{{$data->klien}}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control flatpickr-basic" id="tanggal" name="tanggal" value="{{$data->tanggal}}" placeholder="Pilih"
                                                style="background-color: white" required>
                                        </div>
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label class="col-sm-12 col-form-label"><b>Lokasi</b></label>
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label class="col-sm-12 col-form-label"><b>Link Project</b></label>
                                        <div class="col-sm-12">
                                          <input type="text" id="link" name="link" value="{{$data->link}}" class="form-control">
                                        </div>
                                    </div>

                                    <div class="form-group col-12">
                                        <label class="col-sm-12 col-form-label"><b>Cover Project</b></label>
                                        <div class="col-sm-12">
                                            <div class="body">
                                            <input type="file" class="upload-photo" name="cover" />
                                            </div>
                                    ...
                                    <div class="form-group col-12">
                                        <label class="col-sm-12 col-form-label"><b>Deskripsi Project</b></label>
