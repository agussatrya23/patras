    ...
    <div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Ubah Pegawai
                    </h2>
                            ...
                            <form id="jquery-val-form" class="forms-sample" action="{{route('md.pegawai.update')}}" method="post" enctype="multipart/form-data" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-sm-12">
                                          <input type="text" id="panggilan" name="panggilan" value="{{$data->panggilan}}" required class="form-control">
                                        </div>
                                    </div>
