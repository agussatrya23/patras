    ...
    <div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Ubah Layanan
                    </h2>
        ...
        <div class="row">
            <div class="col-12">
                <div class="content-body">
                    <div class="card">
                        <div class="card-body">
                            <form id="jquery-val-form" class="forms-sample" action="{{route('md.layanan.update')}}" method="post" enctype="multipart/form-data" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-sm-12">
                                          <input type="text" id="namabrand" name="namabrand" value="{{$data->namabrand}}" required class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" name="cp" value="{{$data->cp}}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-sm-12">
                                          <input type="text" name="sosmed" value="{{$data->sosmed}}" class="form-control">
                                        </div>
                                    </div>
...
<script>
    ...
    $(element_gambar).filepond('addFile', '{{ asset($data->descimg) }}');
</script>
...
<script>
    ...
    pondphoto.addEventListener('FilePond:removefile', function (e, file) {
        ...
        if (edit_photo < 1) {
            edit_photo = edit_photo + 1;
            crop_photo = 0;
        }
    });

    $(element_photo).filepond('addFile', '{{ asset($data->coverimg) }}');
</script>
